...
class MainActivity : AppCompatActivity(), MainAdapter.onSelectData {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imgLogout.setOnClickListener {
            val intent = Intent(this@MainActivity, Activity_Splash_Login::class.java)

            startActivity(intent)
        }

        //
        var welcomeMsg = "Hello, " + intent.getStringExtra("username") + ", Our Food Lovers!"
        txtWelcome.text = welcomeMsg
    }
